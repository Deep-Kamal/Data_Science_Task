...
✅ Risk Management
    Avoid overtrading in high greed conditions
    Focus on high-probability setups in fear phases
🛠️ Tech Stack
    Python 🐍
    Pandas
    Matplotlib
...
🙌 Conclusion
  Market sentiment strongly impacts trader performance.
  The most profitable opportunities arise during Fear-driven markets, supporting a contrarian trading approach.

📬 Submission
  This project was completed as part of a Data Science assignment for trading analytics.
